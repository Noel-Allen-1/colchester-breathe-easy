...
function NewsletterBaseItem(props) {
    const { id, heading, description, image, imageID, date, template, userId, userName } = props
    ...
    return (
            <Container style={{marginBottom:"7px"}}>
                ...
                <div style={{cursor:"pointer"}} onClick={handleOpenNewsletter}>
                    <>
                    <div className="nl-head" style={{backgroundColor:"rgba(0,135,255,0.8)", color:"rgba(255,255,255,1)", paddingTop:"6px", paddingBottom:"7px", marginBottom:"6px", textAlign:"center"}}>
                        {parse(stripHtml(heading))}
                    </div>
                    <div className="nl-image image-container">
                        <Image src={`/assets/images/nl-5.png`} layout="fill" className={'image'} alt="newsletter button" title="newsletter button" />
                    </div>
                   {date ? (
                        <div className="nl-date"  style={{backgroundColor:"rgba(0,135,255,0.8)", color:"rgba(255,255,255,1)", textAlign:"center", paddingTop:"6px", paddingBottom:"7px" }}>
...
export default NewsletterBaseItem